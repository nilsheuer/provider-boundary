...
PROJECT_REPO ?= github.com/nilsheuer/$(PROJECT_NAME)

export TERRAFORM_VERSION ?= 1.2.1

export TERRAFORM_PROVIDER_SOURCE ?= hashicorp/boundary
export TERRAFORM_PROVIDER_REPO ?= https://github.com/hashicorp/terraform-provider-boundary
export TERRAFORM_PROVIDER_VERSION ?= 1.1.14
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-boundary
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-boundary_v1.1.14
...
xpkg.build.provider-boundary: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/boundarys/01-delete.yaml.tmpl.
